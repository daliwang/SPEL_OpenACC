...
contains
  ...
  !-----------------------------------------------------------------------
!#py    subroutine readDecompBGCParams(ncid )
!#py      !
!#py      ! !DESCRIPTION:
!#py      !
!#py      ! !USES:
...
!#py      !
!#py      ! !LOCAL VARIABLES:
!#py      character(len=32)  :: subname = 'DecompBGCParamsType'
!#py      character(len=100) :: errCode = 'Error reading in CN const file '
...
!#py      !-----------------------------------------------------------------------
!#py 
!#py      allocate(DecompBGCParamsInst%cn_s1_bgc   )
!#py      allocate(DecompBGCParamsInst%cn_s2_bgc   )
!#py      allocate(DecompBGCParamsInst%cn_s3_bgc   )
!#py      allocate(DecompBGCParamsInst%np_s1_new_bgc)
!#py      allocate(DecompBGCParamsInst%np_s2_new_bgc)
!#py      allocate(DecompBGCParamsInst%np_s3_new_bgc)
!#py      allocate(DecompBGCParamsInst%cp_s1_new_bgc)
!#py      allocate(DecompBGCParamsInst%cp_s2_new_bgc)
!#py      allocate(DecompBGCParamsInst%cp_s3_new_bgc)
!#py      allocate(DecompBGCParamsInst%rf_l1s1_bgc )
!#py      allocate(DecompBGCParamsInst%rf_l2s1_bgc )
!#py      allocate(DecompBGCParamsInst%rf_l3s2_bgc )
!#py      allocate(DecompBGCParamsInst%rf_s2s1_bgc )
!#py      allocate(DecompBGCParamsInst%rf_s2s3_bgc )
!#py      allocate(DecompBGCParamsInst%rf_s3s1_bgc )
!#py      allocate(DecompBGCParamsInst%rf_cwdl2_bgc)
!#py      allocate(DecompBGCParamsInst%rf_cwdl3_bgc)
!#py      allocate(DecompBGCParamsInst%tau_l1_bgc  )
!#py      allocate(DecompBGCParamsInst%tau_l2_l3_bgc)
!#py      allocate(DecompBGCParamsInst%tau_s1_bgc  )
!#py      allocate(DecompBGCParamsInst%tau_s2_bgc  )
!#py      allocate(DecompBGCParamsInst%tau_s3_bgc  )
!#py      allocate(DecompBGCParamsInst%tau_cwd_bgc )
!#py      allocate(DecompBGCParamsInst%cwd_fcel_bgc)
!#py      allocate(DecompBGCParamsInst%cwd_flig_bgc)
!#py      allocate(DecompBGCParamsInst%k_frag_bgc  )
!#py      allocate(DecompBGCParamsInst%minpsi_bgc  )
!#py 
!#py      ! These are not read off of netcdf file
!#py      allocate(DecompBGCParamsInst%nsompools); DecompBGCParamsInst%nsompools = 3
!#py      allocate(DecompBGCParamsInst%spinup_vector(DecompBGCParamsInst%nsompools))
!#py      DecompBGCParamsInst%spinup_vector(:) = (/ 1.0_r8, 15.0_r8, 675.0_r8 /)
!#py 
...
!#py      DecompBGCParamsInst%tau_l1_bgc=tempr
!#py 
!#py      tString='tau_l2_l3'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%tau_l2_l3_bgc=tempr
!#py 
!#py      tString='tau_s1'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%tau_s1_bgc=tempr
!#py 
!#py      tString='tau_s2'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%tau_s2_bgc=tempr
!#py 
!#py      tString='tau_s3'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%tau_s3_bgc=tempr
!#py 
!#py      tString='tau_cwd'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%tau_cwd_bgc=tempr
!#py 
!#py      tString='cn_s1_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%cn_s1_bgc=tempr
!#py 
!#py      tString='cn_s2_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%cn_s2_bgc=tempr
!#py 
!#py      tString='cn_s3_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%cn_s3_bgc=tempr
!#py 
!#py  !!! read in phosphorus variables - note that these NP ratio parameters for BGC  will have
!#py  !!! to be added in the parameter file
!#py 
!#py      tString='np_s1_new'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%np_s1_new_bgc=tempr
!#py 
!#py      tString='np_s2_new'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%np_s2_new_bgc=tempr
!#py 
!#py      tString='np_s3_new'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%np_s3_new_bgc=tempr
!#py 
!#py      tString='rf_l1s1_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_l1s1_bgc=tempr
!#py 
!#py      tString='rf_l2s1_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_l2s1_bgc=tempr
!#py 
!#py      tString='rf_l3s2_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_l3s2_bgc=tempr
!#py 
!#py      tString='rf_s2s1_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_s2s1_bgc=tempr
!#py 
!#py      tString='rf_s2s3_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_s2s3_bgc=tempr
!#py 
!#py      tString='rf_s3s1_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_s3s1_bgc=tempr
!#py 
!#py      tString='rf_cwdl2_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_cwdl2_bgc=tempr
!#py 
!#py      tString='rf_cwdl3_bgc'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%rf_cwdl3_bgc=tempr
!#py 
!#py      tString='cwd_fcel'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%cwd_fcel_bgc=tempr
!#py 
!#py      tString='k_frag'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%k_frag_bgc=tempr
!#py 
!#py      tString='minpsi_hr'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%minpsi_bgc=tempr
!#py 
!#py      tString='cwd_flig'
!#py      call ncd_io(trim(tString),tempr, 'read', ncid, readvar=readv)
!#py      if ( .not. readv ) call endrun(msg=trim(errCode)//trim(tString)//errMsg(__FILE__, __LINE__))
!#py      DecompBGCParamsInst%cwd_flig_bgc=tempr
!#py 
!#py    end subroutine readDecompBGCParams
