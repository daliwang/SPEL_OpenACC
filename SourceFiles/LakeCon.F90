...
contains
  ...
  subroutine LakeConInit()
    ...
    !#py if (masterproc) write (iulog,*) 'Attempting to initialize time invariant variables for lakes'
    ...
    !#py if (masterproc) write (iulog,*) 'Successfully initialized time invariant variables for lakes'
