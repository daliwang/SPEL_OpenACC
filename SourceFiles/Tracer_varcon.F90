module Tracer_varcon
  ...
  real*8, parameter :: SHR_CONST_VSMOW_O18 = 2005.20d-6  ! ratio of 18O/16O in Vienna Standard Mean Ocean Water (VSMOW)
  real*8, parameter :: SHR_CONST_VSMOW_O17 = 379.9d-6    ! ratio of 17O/16O in Vienna Standard Mean Ocean Water (VSMOW)
  real*8, parameter :: SHR_CONST_VSMOW_D = 155.76d-6     ! ratio of D/H in Vienna Standard Mean Ocean Water (VSMOW)
  real*8, parameter :: SHR_CONST_VSMOW_T = 1.85d-6       ! ratio of T/H in Vienna Standard Mean Ocean Water (VSMOW)

  real*8, parameter :: catomw = 12.011D0      ! molar mass of C atoms (g/mol)
  real*8, parameter :: natomw = 14.007D0      ! molar mass of N atoms (g/mol)
  real*8, parameter :: patomw = 30.97D0       ! molar mass of P atmos (g/mol)
  real*8, parameter :: c13atomw = 13.D0       ! molar mass of C13 atmos (g/mol)
  real*8, parameter :: c14atomw = 14.D0       ! molar mass of C14 atmos (g/mol)
  ...
  !$acc declare copyin(is_active_betr_bgc)
  ...
  character(len=128), public :: reaction_method

  integer, public :: betr_nlevsoi
  integer, public :: betr_nlevsno
  integer, public :: betr_nlevtrc_soil
  !$acc declare create(betr_nlevsoi,betr_nlevsno, betr_nlevtrc_soil )
  !
