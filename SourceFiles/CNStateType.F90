...
contains
  ...
  subroutine InitHistory(this, bounds)
    ...
    ! !USES:
    !#py use shr_infnan_mod , only : nan => shr_infnan_nan, assignment(=)
    !#py use histFileMod    , only : hist_addfld1d, hist_addfld2d, hist_addfld_decomp, no_snow_normal
    !
    ! !ARGUMENTS:
    class(cnstate_type) :: this
    type(bounds_type), intent(in) :: bounds
    ...
    if ( crop_prog) then
       ...
       !#py call hist_addfld1d (fname='GDDHARV', units='ddays', &
            !#py avgflag='A', long_name='Growing degree days (gdd) needed to harvest', &
            !#py !#py ptr_patch=this%gddmaturity_patch, default='inactive')
    end if

    this%croot_prof_patch(begp:endp,:) = spval
    !#py call hist_addfld_decomp (fname='CROOT_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for litter C and N inputs from coarse roots', &
         !#py !#py ptr_patch=this%croot_prof_patch, default='inactive')

    this%froot_prof_patch(begp:endp,:) = spval
    !#py call hist_addfld_decomp (fname='FROOT_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for litter C and N inputs from fine roots', &
         !#py !#py ptr_patch=this%froot_prof_patch, default='inactive')

    this%leaf_prof_patch(begp:endp,:) = spval
    !#py call hist_addfld_decomp (fname='LEAF_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for litter C and N inputs from leaves', &
         !#py !#py ptr_patch=this%leaf_prof_patch, default='inactive')

    this%stem_prof_patch(begp:endp,:) = spval
    !#py call hist_addfld_decomp (fname='STEM_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for litter C and N inputs from stems', &
         !#py !#py ptr_patch=this%stem_prof_patch, default='inactive')

    this%nfixation_prof_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='NFIXATION_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for biological N fixation', &
         !#py !#py ptr_col=this%nfixation_prof_col, default='inactive')

    this%ndep_prof_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='NDEP_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for atmospheric N  deposition', &
         !#py !#py ptr_col=this%ndep_prof_col, default='inactive')

    this%pdep_prof_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='PDEP_PROF', units='1/m',  type2d='levdcmp', &
         !#py avgflag='A', long_name='profile for atmospheric P  deposition', &
         !#py !#py ptr_col=this%pdep_prof_col, default='inactive')

    this%som_adv_coef_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='SOM_ADV_COEF', units='m/s',  type2d='levdcmp', &
         !#py avgflag='A', long_name='advection term for vertical SOM translocation', &
         !#py !#py ptr_col=this%som_adv_coef_col, default='inactive')

    this%som_diffus_coef_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='SOM_DIFFUS_COEF', units='m^2/s',  type2d='levdcmp', &
         !#py avgflag='A', long_name='diffusion coefficient for vertical SOM translocation', &
         !#py !#py ptr_col=this%som_diffus_coef_col, default='inactive')

    this%lfc2_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='LFC2', units='per sec', &
         !#py avgflag='A', long_name='conversion area fraction of BET and BDT that burned', &
         !#py !#py ptr_col=this%lfc2_col)

    if ( nlevdecomp_full > 1 ) then
       this%fpi_col(begc:endc) = spval
       !#py call hist_addfld1d (fname='FPI', units='proportion', &
            !#py avgflag='A', long_name='fraction of potential immobilization of nitrogen', &
            !#py !#py ptr_col=this%fpi_col)
       this%fpi_p_col(begc:endc) = spval
       !#py call hist_addfld1d (fname='FPI_P', units='proportion', &
            !#py avgflag='A', long_name='fraction of potential immobilization of phosphorus', &
            !#py !#py ptr_col=this%fpi_p_col)
    endif
    ...
    !#py call hist_addfld_decomp (fname='FPI'//trim(vr_suffix), units='proportion', type2d='levdcmp', &
         !#py avgflag='A', long_name='fraction of potential immobilization of nitrogen', &
         !#py !#py ptr_col=this%fpi_vr_col)
    this%fpi_p_vr_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp (fname='FPI_P'//trim(vr_suffix), units='proportion', type2d='levdcmp', &
         !#py avgflag='A', long_name='fraction of potential immobilization of phosphorus', &
         !#py !#py ptr_col=this%fpi_p_vr_col)

    this%fpg_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='FPG', units='proportion', &
         !#py avgflag='A', long_name='fraction of potential gpp due to N limitation', &
         !#py !#py ptr_col=this%fpg_col)

    this%fpg_p_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='FPG_P', units='proportion', &
         !#py avgflag='A', long_name='fraction of potential gpp due to P limitation', &
         !#py !#py ptr_col=this%fpg_p_col)

    this%annsum_counter_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='ANNSUM_COUNTER', units='s', &
         !#py avgflag='A', long_name='seconds since last annual accumulator turnover', &
         !#py !#py ptr_col=this%annsum_counter_col, default='inactive')

    this%annavg_t2m_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='CANNAVG_T2M', units='K', &
         !#py avgflag='A', long_name='annual average of 2m air temperature', &
         !#py !#py ptr_col=this%annavg_t2m_col, default='inactive')

    this%scalaravg_col(begc:endc,:) = spval
    !#py call hist_addfld_decomp(fname='SCALARAVG'//trim(vr_suffix), units='fraction', &
         !#py type2d='levdcmp', avgflag='A', long_name='average of decomposition scalar',&
         !#py !#py ptr_col=this%scalaravg_col)

    this%nfire_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='NFIRE',  units='counts/km2/sec', &
         !#py avgflag='A', long_name='fire counts valid only in Reg.C', &
         !#py !#py ptr_col=this%nfire_col)

    this%farea_burned_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='FAREA_BURNED',  units='proportion', &
         !#py avgflag='A', long_name='timestep fractional area burned', &
         !#py !#py ptr_col=this%farea_burned_col)

    this%baf_crop_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='BAF_CROP',  units='proportion/sec', &
         !#py avgflag='A', long_name='fractional area burned for crop', &
         !#py !#py ptr_col=this%baf_crop_col)

    this%baf_peatf_col(begc:endc) = spval
    !#py call hist_addfld1d (fname='BAF_PEATF',  units='proportion/sec', &
         !#py avgflag='A', long_name='fractional area burned in peatland', &
         !#py !#py ptr_col=this%baf_peatf_col)

    this%annavg_t2m_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ANNAVG_T2M', units='K', &
         !#py avgflag='A', long_name='annual average 2m air temperature', &
         !#py !#py ptr_patch=this%annavg_t2m_patch, default='inactive')

    this%tempavg_t2m_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='TEMPAVG_T2M', units='K', &
         !#py avgflag='A', long_name='temporary average 2m air temperature', &
         !#py !#py ptr_patch=this%tempavg_t2m_patch, default='inactive')

    this%dormant_flag_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='DORMANT_FLAG', units='1', &
         !#py avgflag='A', long_name='dormancy flag', &
         !#py !#py ptr_patch=this%dormant_flag_patch, default='inactive')

    this%days_active_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='DAYS_ACTIVE', units='days', &
         !#py avgflag='A', long_name='number of days since last dormancy', &
         !#py !#py ptr_patch=this%days_active_patch, default='inactive')

    this%onset_flag_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_FLAG', units='1', &
         !#py avgflag='A', long_name='onset flag', &
         !#py !#py ptr_patch=this%onset_flag_patch, default='inactive')

    this%onset_counter_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_COUNTER', units='days', &
         !#py avgflag='A', long_name='onset days counter', &
         !#py !#py ptr_patch=this%onset_counter_patch, default='inactive')

    this%onset_gddflag_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_GDDFLAG', units='1', &
         !#py avgflag='A', long_name='onset flag for growing degree day sum', &
         !#py !#py ptr_patch=this%onset_gddflag_patch, default='inactive')

    this%onset_fdd_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_FDD', units='C degree-days', &
         !#py avgflag='A', long_name='onset freezing degree days counter', &
         !#py !#py ptr_patch=this%onset_fdd_patch, default='inactive')

    this%onset_gdd_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_GDD', units='C degree-days', &
         !#py avgflag='A', long_name='onset growing degree days', &
         !#py !#py ptr_patch=this%onset_gdd_patch, default='inactive')

    this%onset_swi_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ONSET_SWI', units='1', &
         !#py avgflag='A', long_name='onset soil water index', &
         !#py !#py ptr_patch=this%onset_swi_patch, default='inactive')

    this%offset_flag_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='OFFSET_FLAG', units='1', &
         !#py avgflag='A', long_name='offset flag', &
         !#py !#py ptr_patch=this%offset_flag_patch, default='inactive')

    this%offset_counter_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='OFFSET_COUNTER', units='days', &
         !#py avgflag='A', long_name='offset days counter', &
         !#py !#py ptr_patch=this%offset_counter_patch, default='inactive')

    this%offset_fdd_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='OFFSET_FDD', units='C degree-days', &
         !#py avgflag='A', long_name='offset freezing degree days counter', &
         !#py !#py ptr_patch=this%offset_fdd_patch, default='inactive')

    this%offset_swi_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='OFFSET_SWI', units='1', &
         !#py avgflag='A', long_name='offset soil water index', &
         !#py !#py ptr_patch=this%offset_swi_patch, default='inactive')

    this%lgsf_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='LGSF', units='proportion', &
         !#py avgflag='A', long_name='long growing season factor', &
         !#py !#py ptr_patch=this%lgsf_patch, default='inactive')

    this%bglfr_leaf_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='BGLFR_LEAF', units='1/s', &
         !#py avgflag='A', long_name='background leaf litterfall rate', &
         !#py !#py ptr_patch=this%bglfr_leaf_patch, default='inactive')

    this%bglfr_froot_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='BGLFR_FROOT', units='1/s', &
         !#py avgflag='A', long_name='background fine root litterfall rate', &
         !#py !#py ptr_patch=this%bglfr_froot_patch, default='inactive')

    this%bgtr_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='BGTR', units='1/s', &
         !#py avgflag='A', long_name='background transfer growth rate', &
         !#py !#py ptr_patch=this%bgtr_patch, default='inactive')

    this%alloc_pnow_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ALLOC_PNOW', units='proportion', &
         !#py avgflag='A', long_name='fraction of current allocation to display as new growth', &
         !#py !#py ptr_patch=this%alloc_pnow_patch, default='inactive')

    this%c_allometry_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='C_ALLOMETRY', units='1', &
         !#py avgflag='A', long_name='C allocation index', &
         !#py !#py ptr_patch=this%c_allometry_patch, default='inactive')

    this%n_allometry_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='N_ALLOMETRY', units='1', &
         !#py avgflag='A', long_name='N allocation index', &
         !#py !#py ptr_patch=this%n_allometry_patch, default='inactive')

    this%tempsum_potential_gpp_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='TEMPSUM_POTENTIAL_GPP', units='gC/m^2/yr', &
         !#py avgflag='A', long_name='temporary annual sum of potential GPP', &
         !#py !#py ptr_patch=this%tempsum_potential_gpp_patch, default='inactive')

    this%annsum_potential_gpp_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ANNSUM_POTENTIAL_GPP', units='gN/m^2/yr', &
         !#py avgflag='A', long_name='annual sum of potential GPP', &
         !#py !#py ptr_patch=this%annsum_potential_gpp_patch, default='inactive')

    this%tempmax_retransn_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='TEMPMAX_RETRANSN', units='gN/m^2', &
         !#py avgflag='A', long_name='temporary annual max of retranslocated N pool', &
         !#py !#py ptr_patch=this%tempmax_retransn_patch, default='inactive')

    this%annmax_retransn_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ANNMAX_RETRANSN', units='gN/m^2', &
         !#py avgflag='A', long_name='annual max of retranslocated N pool', &
         !#py !#py ptr_patch=this%annmax_retransn_patch, default='inactive')

    this%downreg_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='DOWNREG', units='proportion', &
         !#py avgflag='A', long_name='fractional reduction in GPP due to N limitation', &
         !#py !#py ptr_patch=this%downreg_patch, default='inactive')


    !! add phosphorus -X.YANG
    this%p_allometry_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='P_ALLOMETRY', units='1', &
         !#py avgflag='A', long_name='P allocation index', &
         !#py !#py ptr_patch=this%p_allometry_patch, default='inactive')

    this%tempmax_retransp_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='TEMPMAX_RETRANSP', units='gP/m^2', &
         !#py avgflag='A', long_name='temporary annual max of retranslocated P pool', &
         !#py !#py ptr_patch=this%tempmax_retransp_patch, default='inactive')

    this%annmax_retransp_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='ANNMAX_RETRANSP', units='gP/m^2', &
         !#py avgflag='A', long_name='annual max of retranslocated P pool', &
         !#py !#py ptr_patch=this%annmax_retransp_patch, default='inactive')

    this%cn_scalar(begp:endp) = spval
    !#py call hist_addfld1d (fname='cn_scalar', units='', &
       !#py avgflag='A', long_name='N limitation factor', &
       !#py !#py ptr_patch=this%cn_scalar, default='active')

    this%cp_scalar(begp:endp) = spval
    !#py call hist_addfld1d (fname='cp_scalar', units='', &
       !#py avgflag='A', long_name='P limitation factor', &
       !#py !#py ptr_patch=this%cp_scalar, default='active')

    this%cn_scalar_runmean(begp:endp) = spval
    !#py call hist_addfld1d (fname='nlim_m', units='', &
       !#py avgflag='A', long_name='runmean N limitation factor', &
       !#py !#py ptr_patch=this%cn_scalar_runmean, default='active')

    this%cp_scalar_runmean(begp:endp) = spval
    !#py call hist_addfld1d (fname='plim_m', units='', &
       !#py avgflag='A', long_name='runmean P limitation factor', &
       !#py !#py ptr_patch=this%cp_scalar_runmean, default='active')

    this%r_mort_cal_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='R_MORT_CAL', units='1', &
         !#py avgflag='A', long_name='calcualted annual mortality rate', &
         !#py !#py ptr_patch=this%r_mort_cal_patch, default='inactive')
  ...
  subroutine initCold(this, bounds)
    ...
    ! --------------------------------------------------------------------
       ...
       !#py write(iulog,*) 'Attempting to read soil color, sand and clay boundary data .....'

    !#py call getfil (fsurdat, locfn, 0)
    !#py call ncd_pio_openfile (ncid, locfn, 0)

    !#py !#py call ncd_inqdlen(ncid,dimid,nlevsoifl,name='nlevsoi')
    if ( .not. more_vertlayers )then
       if ( nlevsoifl /= nlevsoi )then
          !#py call endrun(msg=' ERROR: Number of soil layers on file does NOT match the number being used'//&
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='gdp', flag='read', data=gdp, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       !#py !#py call endrun(msg=' ERROR: gdp NOT on surfdata file'//errMsg(__FILE__, __LINE__))
    end if
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='peatf', flag='read', data=peatf, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       !#py !#py call endrun(msg=' ERROR: peatf NOT on surfdata file'//errMsg(__FILE__, __LINE__))
    end if
    do c = bounds%begc, bounds%endc
       g = col_pp%gridcell(c)
    ...
    if ( (nu_com .eq. 'RD' .or. nu_com .eq. 'ECA') .and. (use_cn .and. .not. use_crop) )  then
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='SOIL_ORDER', flag='read',data=soilorder_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: SOIL_ORDER NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
    ...
    if (forest_fert_exp) then
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='fert_type', flag='read',data=fert_type_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: fert_type NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='fert_continue', flag='read',data=fert_continue_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: fert_continue NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='fert_dose', flag='read',data=fert_dose_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: fert_dose NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
          do j = 1 , 12
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='fert_startyr', flag='read',data=fert_start_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: fert_start NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
       ...
       !#py !#py call ncd_io(ncid=ncid, varname='fert_endyr', flag='read',data=fert_end_rdin, dim1name=grlnd, readvar=readvar)
       if (.not. readvar) then
          !#py !#py call endrun(msg=' ERROR: fert_endyr NOT on surfdata file'//errMsg(__FILE__, __LINE__))
       end if
       do c = bounds%begc, bounds%endc
          g = col_pp%gridcell(c)
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='abm', flag='read', data=abm, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       !#py !#py call endrun(msg=' ERROR: abm NOT on surfdata file'//errMsg(__FILE__, __LINE__))
    end if
    do c = bounds%begc, bounds%endc
       g = col_pp%gridcell(c)
    ...
    !#py call ncd_pio_closefile(ncid)
       ...
       !#py write(iulog,*) 'Successfully read fmax, soil color, sand and clay boundary data'
       !#py write(iulog,*)

       !#py write(iulog,*) 'Attempting to read initial phosphorus pools data .....'
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='LABILE_P', flag='read', data=labp_g, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='SECONDARY_P', flag='read', data=secp_g, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       this%pdatasets_present = .false.
    else
       do c = bounds%begc, bounds%endc
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='OCCLUDED_P', flag='read', data=occp_g, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       this%pdatasets_present = .false.
    else
       do c = bounds%begc, bounds%endc
    ...
    !#py !#py call ncd_io(ncid=ncid, varname='APATITE_P', flag='read', data=prip_g, dim1name=grlnd, readvar=readvar)
    if (.not. readvar) then
       this%pdatasets_present = .false.
    else
       do c = bounds%begc, bounds%endc
...
!#py     !-----------------------------------------------------------------------
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='dormant_flag', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='dormancy flag', units='1', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%dormant_flag_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='days_active', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='number of days since last dormancy', units='days' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%days_active_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_flag', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='flag if critical growing degree-day sum is exceeded', units='1' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_flag_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_counter', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='onset days counter', units='sec' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_counter_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_gddflag', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='onset flag for growing degree day sum', units='' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_gddflag_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_fdd', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='onset freezing degree days counter', units='days' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_fdd_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_gdd', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='onset growing degree days', units='days' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_gdd_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='onset_swi', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='onset soil water index', units='days' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%onset_swi_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='offset_flag', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='offset flag', units='1' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%offset_flag_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='offset_counter', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='offset days counter', units='sec' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%offset_counter_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='offset_fdd', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='offset freezing degree days counter', units='days' , &
!#py          interpinic_flag='interp', readvar=readvar, data=this%offset_fdd_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='offset_swi', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%offset_swi_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='lgsf', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%lgsf_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='bglfr', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%bglfr_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='bglfr_leaf', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%bglfr_leaf_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='bglfr_froot', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%bglfr_froot_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='bgtr', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%bgtr_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='annavg_t2m', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annavg_t2m_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='tempavg_t2m', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%tempavg_t2m_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='alloc_pnow', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%alloc_pnow_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='c_allometry', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%c_allometry_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='n_allometry', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%n_allometry_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='tempsum_potential_gpp', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%tempsum_potential_gpp_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='annsum_potential_gpp', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annsum_potential_gpp_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='tempmax_retransn', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%tempmax_retransn_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='annmax_retransn', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annmax_retransn_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='downreg', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%downreg_patch)
!#py
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='p_allometry', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%p_allometry_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='tempmax_retransp', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%tempmax_retransp_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='annmax_retransp', xtype=ncd_double,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annmax_retransp_patch)
!#py
!#py     if (use_vertsoilc) then
!#py        ptr2d => this%fpi_vr_col
!#py        call restartvar(ncid=ncid, flag=flag, varname='fpi_vr', xtype=ncd_double,  &
!#py             dim1name='column',dim2name='levgrnd', switchdim=.true., &
!#py             long_name='fraction of potential immobilization of nitrogen',  units='1', &
!#py             interpinic_flag='interp', readvar=readvar, data=ptr2d)
!#py        ptr2d => this%fpi_p_vr_col
!#py        call restartvar(ncid=ncid, flag=flag, varname='fpi_p_vr', xtype=ncd_double,  &
!#py             dim1name='column',dim2name='levgrnd', switchdim=.true., &
!#py             long_name='fraction of potential immobilization of phosphorus',  units='1', &
!#py             interpinic_flag='interp', readvar=readvar, data=ptr2d)
!#py     else
!#py        ptr1d => this%fpi_vr_col(:,1) ! nlevdecomp = 1; so treat as 1D variable
!#py        call restartvar(ncid=ncid, flag=flag, varname='fpi', xtype=ncd_double,  &
!#py             dim1name='column', &
!#py             long_name='fraction of potential immobilization of nitrogen',  units='1', &
!#py             interpinic_flag='interp' , readvar=readvar, data=ptr1d)
!#py        ptr1d => this%fpi_p_vr_col(:,1) ! nlevdecomp = 1; so treat as 1D variable
!#py        call restartvar(ncid=ncid, flag=flag, varname='fpi_p', xtype=ncd_double,  &
!#py             dim1name='column', &
!#py             long_name='fraction of potential immobilization of phosphorus',  units='1', &
!#py             interpinic_flag='interp' , readvar=readvar, data=ptr1d)
!#py     end if
!#py
!#py     if (use_vertsoilc) then
!#py        ptr2d => this%som_adv_coef_col
!#py        call restartvar(ncid=ncid, flag=flag, varname='som_adv_coef_vr', xtype=ncd_double,  &
!#py             dim1name='column',dim2name='levgrnd', switchdim=.true., &
!#py             long_name='SOM advective flux', units='m/s', fill_value=spval, &
!#py             interpinic_flag='interp', readvar=readvar, data=ptr2d)
!#py     end if
!#py
!#py     if (use_vertsoilc) then
!#py        ptr2d => this%som_diffus_coef_col
!#py        call restartvar(ncid=ncid, flag=flag, varname='som_diffus_coef_vr', xtype=ncd_double,  &
!#py             dim1name='column',dim2name='levgrnd', switchdim=.true., &
!#py             long_name='SOM diffusivity due to bio/cryo-turbation',  units='m^2/s', fill_value=spval, &
!#py             interpinic_flag='interp', readvar=readvar, data=ptr2d)
!#py     end if
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='fpg', xtype=ncd_double,  &
!#py          dim1name='column', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%fpg_col)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='fpg_p', xtype=ncd_double,  &
!#py          dim1name='column', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%fpg_p_col)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='annsum_counter', xtype=ncd_double,  &
!#py          dim1name='column', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annsum_counter_col)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='burndate', xtype=ncd_int,  &
!#py          dim1name='pft', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%burndate_patch)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='lfc', xtype=ncd_double,  &
!#py          dim1name='column', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%lfc_col)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='cannavg_t2m', xtype=ncd_double,  &
!#py          dim1name='column', &
!#py          long_name='', units='', &
!#py          interpinic_flag='interp', readvar=readvar, data=this%annavg_t2m_col)
!#py
!#py     ptr2d => this%scalaravg_col
!#py     call restartvar(ncid=ncid, flag=flag, varname='scalaravg_col', xtype=ncd_double,  &
!#py             dim1name='column',dim2name='levgrnd', switchdim=.true., &
!#py             long_name='fraction of potential immobilization of phosphorus', units='1', &
!#py             interpinic_flag='interp', readvar=readvar, data=ptr2d)
!#py
...
!#py
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='htmx', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='max height attained by a crop during year', units='m', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%htmx_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='peaklai', xtype=ncd_int,  &
!#py             dim1name='pft', long_name='Flag if at max allowed LAI or not', &
!#py             flag_values=(/0,1/), nvalid_range=(/0,1/), &
!#py             flag_meanings=(/'NOT-at-peak', 'AT_peak-LAI' /) , &
!#py             interpinic_flag='interp', readvar=readvar, data=this%peaklai_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='idop', xtype=ncd_int,  &
!#py             dim1name='pft', long_name='Date of planting', units='jday', nvalid_range=(/1,366/), &
!#py             interpinic_flag='interp', readvar=readvar, data=this%idop_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='aleaf', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='leaf allocation coefficient', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%aleaf_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='aleafi', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='Saved leaf allocation coefficient from phase 2', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%aleafi_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='astem', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='stem allocation coefficient', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%astem_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='astemi', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='Saved stem allocation coefficient from phase 2', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%astemi_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='hdidx', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cold hardening index', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%hdidx_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='cumvd', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cumulative vernalization d', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%cumvd_patch)
!#py
!#py       call restartvar(ncid=ncid, flag=flag,  varname='gddmaturity', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='Growing degree days needed to harvest', units='ddays', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%gddmaturity_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='huileaf', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='heat unit index needed from planting to leaf emergence', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%huileaf_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag,  varname='huigrain', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='heat unit index needed to reach vegetative maturity', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%huigrain_patch)
!#py
!#py        call restartvar(ncid=ncid, flag=flag, varname='grain_flag', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%grain_flag_patch)
!#py     end if
!#py
!#py     if (use_c14) then
!#py        call restartvar(ncid=ncid, flag=flag, varname='rc14_atm', xtype=ncd_double,  &
!#py             dim1name='pft',    long_name='', units='', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%rc14_atm_patch)
!#py        if (flag=='read' .and. .not. readvar) then
!#py           write(iulog,*) 'initializing this%rc14_atm with atmospheric c14 value'
!#py           do i = bounds%begp, bounds%endp
!#py              this%rc14_atm_patch(i) = c14ratio
!#py           end do
!#py        end if
!#py     end if
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='cn_scalar', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cn_scalar', units='-', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%cn_scalar)
!#py     call restartvar(ncid=ncid, flag=flag, varname='cp_scalar', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cp_scalar', units='-', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%cp_scalar)
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='nlim_m', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cn_scalar_runmean', units='-', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%cn_scalar_runmean)
!#py     call restartvar(ncid=ncid, flag=flag, varname='plim_m', xtype=ncd_double,  &
!#py             dim1name='pft', long_name='cp_scalar_runmean', units='-', &
!#py             interpinic_flag='interp', readvar=readvar, data=this%cp_scalar_runmean)
!#py
!#py !#py !#py   end subroutine Restart
  ...
  subroutine InitAccBuffer (this, bounds)
    ...
    !#py call init_accum_field (name='nlim_m', units='-',                                              &
         !#py desc='runing average of N limitation strength',  accum_type='runmean', accum_period=-7300,    &
         !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)

    this%cp_scalar_runmean(bounds%begp:bounds%endp) = spval
    !#py call init_accum_field (name='plim_m', units='-',                                              &
         !#py desc='runing average of P limitation strength',  accum_type='runmean', accum_period=-7300,    &
         !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)
  ...
  subroutine InitAccVars(this, bounds)
    ...
    ! !USES
    !#py use accumulMod       , only : init_accum_field, extract_accum_field
    ...
    !#py call extract_accum_field ('nlim_m', rbufslp, nstep)
    this%cn_scalar_runmean(begp:endp) = rbufslp(begp:endp)

    !#py call extract_accum_field ('plim_m', rbufslp, nstep)
...
!#py     endif
!#py
!#py     ! Accumulate and extract
!#py     do p = begp,endp
!#py        rbufslp(p) = this%cn_scalar(p)
!#py     end do
!#py     call update_accum_field  ('nlim_m' , rbufslp             , nstep)
!#py     call extract_accum_field ('nlim_m' , this%cn_scalar_runmean  , nstep)
!#py     do p = begp,endp
!#py        rbufslp(p) = this%cp_scalar(p)
!#py     end do
!#py     call update_accum_field  ('plim_m' , rbufslp             , nstep)
!#py     call extract_accum_field ('plim_m' , this%cp_scalar_runmean  , nstep)
