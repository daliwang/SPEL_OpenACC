...
!#py     !
!#py     ! History fields initialization
!#py     !
!#py     ! !USES:
...
!#py     !
!#py     ! !ARGUMENTS:
!#py     class(surfrad_type) :: this
!#py     type(bounds_type), intent(in) :: bounds
!#py     !
!#py     ! !LOCAL VARIABLES:
!#py     integer :: begp, endp
!#py     integer :: begc, endc
!#py     real(r8), pointer :: data2dptr(:,:) ! temp. pointers for slicing larger arrays
!#py     !---------------------------------------------------------------------
!#py 
...
!#py        this%sfc_frc_aer_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOAERFRCL', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of all aerosols in snow (land) ', &
!#py             ptr_patch=this%sfc_frc_aer_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_aer_sno_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOAERFRC2L', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of all aerosols in snow, averaged only when snow is present (land)', &
!#py             ptr_patch=this%sfc_frc_aer_sno_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_bc_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOBCFRCL', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of BC in snow (land) ', &
!#py             ptr_patch=this%sfc_frc_bc_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_bc_sno_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOBCFRC2L', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of BC in snow, averaged only when snow is present (land)', &
!#py             ptr_patch=this%sfc_frc_bc_sno_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_oc_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOOCFRCL', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of OC in snow (land) ', &
!#py             ptr_patch=this%sfc_frc_oc_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_oc_sno_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNOOCFRC2L', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of OC in snow, averaged only when snow is present (land)', &
!#py             ptr_patch=this%sfc_frc_oc_sno_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_dst_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNODSTFRCL', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of dust in snow (land) ', &
!#py             ptr_patch=this%sfc_frc_dst_patch, set_urb=spval)
!#py 
!#py        this%sfc_frc_dst_sno_patch(begp:endp) = spval
!#py        call hist_addfld1d (fname='SNODSTFRC2L', units='W/m^2', &
!#py             avgflag='A', long_name='surface forcing of dust in snow, averaged only when snow is present (land)', &
!#py             ptr_patch=this%sfc_frc_dst_sno_patch, set_urb=spval)
!#py     end if
!#py 
!#py     this%fsds_vis_d_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSDSVD', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis incident solar radiation', &
!#py          ptr_patch=this%fsds_vis_d_patch)
!#py 
!#py     this%fsds_vis_i_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSDSVI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse vis incident solar radiation', &
!#py          ptr_patch=this%fsds_vis_i_patch)
!#py 
!#py     this%fsr_vis_d_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSRVD', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis reflected solar radiation', &
!#py          ptr_patch=this%fsr_vis_d_patch, c2l_scale_type='urbanf')
!#py 
!#py     this%fsr_vis_i_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSRVI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse vis reflected solar radiation', &
!#py          ptr_patch=this%fsr_vis_i_patch, c2l_scale_type='urbanf')
!#py 
!#py     this%fsds_vis_d_ln_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSDSVDLN', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis incident solar radiation at local noon', &
!#py          ptr_patch=this%fsds_vis_d_ln_patch)
!#py 
!#py     this%fsds_vis_i_ln_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSDSVILN', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse vis incident solar radiation at local noon', &
!#py          ptr_patch=this%fsds_vis_i_ln_patch)
!#py 
!#py     this%parveg_ln_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='PARVEGLN', units='W/m^2',  &
!#py          avgflag='A', long_name='absorbed par by vegetation at local noon', &
!#py          ptr_patch=this%parveg_ln_patch)
!#py 
!#py     this%fsr_vis_d_ln_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='FSRVDLN', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis reflected solar radiation at local noon', &
!#py          ptr_patch=this%fsr_vis_d_ln_patch, c2l_scale_type='urbanf')
!#py 
!#py     this%fsds_sno_vd_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSDSVD', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis incident solar radiation on snow', &
!#py          ptr_patch=this%fsds_sno_vd_patch, default='inactive')
!#py 
!#py     this%fsds_sno_nd_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSDSND', units='W/m^2',  &
!#py          avgflag='A', long_name='direct nir incident solar radiation on snow', &
!#py          ptr_patch=this%fsds_sno_nd_patch, default='inactive')
!#py 
!#py     this%fsds_sno_vi_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSDSVI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse vis incident solar radiation on snow', &
!#py          ptr_patch=this%fsds_sno_vi_patch, default='inactive')
!#py 
!#py     this%fsds_sno_ni_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSDSNI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse nir incident solar radiation on snow', &
!#py          ptr_patch=this%fsds_sno_ni_patch, default='inactive')
!#py 
!#py     this%fsr_sno_vd_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSRVD', units='W/m^2',  &
!#py          avgflag='A', long_name='direct vis reflected solar radiation from snow', &
!#py          ptr_patch=this%fsr_sno_vd_patch, default='inactive')
!#py 
!#py     this%fsr_sno_nd_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSRND', units='W/m^2',  &
!#py          avgflag='A', long_name='direct nir reflected solar radiation from snow', &
!#py          ptr_patch=this%fsr_sno_nd_patch, default='inactive')
!#py 
!#py     this%fsr_sno_vi_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSRVI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse vis reflected solar radiation from snow', &
!#py          ptr_patch=this%fsr_sno_vi_patch, default='inactive')
!#py 
!#py     this%fsr_sno_ni_patch(begp:endp) = spval
!#py     call hist_addfld1d (fname='SNOFSRNI', units='W/m^2',  &
!#py          avgflag='A', long_name='diffuse nir reflected solar radiation from snow', &
!#py          ptr_patch=this%fsr_sno_ni_patch, default='inactive')
!#py 
...
#ifndef _OPENACC
             !#py write(iulog,*)"SNICAR ERROR: Absorbed ground radiation not equal to summed snow layer radiation"
             !#py write(iulog,*)"Diff        = ",sum(sabg_lyr(p,:))-sabg_snow(p)
             !#py write(iulog,*)"sabg_snow(p)= ",sabg_snow(p)
             !#py write(iulog,*)"sabg_sum(p) = ",sum(sabg_lyr(p,:))
             !#py write(iulog,*)"snl(c)      = ",snl(c)
             !#py write(iulog,*)"flx_absdv1  = ",trd(p,1)*(1.-albgrd(c,1))
             !#py write(iulog,*)"flx_absdv2  = ",sum(flx_absdv(c,:))*trd(p,1)
             !#py write(iulog,*)"flx_absiv1  = ",tri(p,1)*(1.-albgri(c,1))
             !#py write(iulog,*)"flx_absiv2  = ",sum(flx_absiv(c,:))*tri(p,1)
             !#py write(iulog,*)"flx_absdn1  = ",trd(p,2)*(1.-albgrd(c,2))
             !#py write(iulog,*)"flx_absdn2  = ",sum(flx_absdn(c,:))*trd(p,2)
             !#py write(iulog,*)"flx_absin1  = ",tri(p,2)*(1.-albgri(c,2))
             !#py write(iulog,*)"flx_absin2  = ",sum(flx_absin(c,:))*tri(p,2)
             !#py write(iulog,*)"albgrd_nir  = ",albgrd(c,2)
             !#py write(iulog,*)"coszen      = ",coszen(c)
