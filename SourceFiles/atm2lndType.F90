...
contains
  ...
  subroutine InitHistory(this, bounds)
    ...
    !#py call hist_addfld1d (fname='QFLOOD',  units='mm/s',  &
         !#py avgflag='A', long_name='runoff from river flooding', &
         !#py !#py ptr_lnd=this%forc_flood_grc)

    this%volr_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='VOLR',  units='m3',  &
         !#py avgflag='A', long_name='river channel total water storage', &
         !#py !#py ptr_lnd=this%volr_grc)

    this%volrmch_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='VOLRMCH',  units='m3',  &
         !#py avgflag='A', long_name='river channel main channel water storage', &
         !#py !#py ptr_lnd=this%volrmch_grc)

    this%supply_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='SUPPLY',  units='mm/s',  &
         !#py avgflag='A', long_name='runoff supply for land use', &
         !#py !#py ptr_lnd=this%supply_grc)

    this%deficit_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='DEFICIT',  units='mm/s',  &
         !#py avgflag='A', long_name='runoff supply deficit', &
         !#py !#py ptr_lnd=this%deficit_grc)
...
!         ptr_lnd=this%forc_wind_grc)
    ...
    !#py call hist_addfld1d (fname='Wind', units='m/s',  &
         ...
         !#py !#py ptr_gcell=this%forc_wind_grc, default = 'inactive')
...
!         ptr_lnd=this%forc_pco2_grc)
    ...
    this%forc_solar_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='SWdown', units='W/m^2',  &
         !#py avgflag='A', long_name='atmospheric incident solar radiation', &
         !#py !#py ptr_gcell=this%forc_solar_grc, default='inactive')
...
!    end if
    ...
    !#py call hist_addfld1d (fname='Tair', units='K',  &
         !#py avgflag='A', long_name='atmospheric air temperature', &
         !#py !#py ptr_gcell=this%forc_t_not_downscaled_grc, default='inactive')

    this%forc_pbot_not_downscaled_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='PSurf', units='Pa',  &
         !#py avgflag='A', long_name='surface pressure', &
         !#py !#py ptr_gcell=this%forc_pbot_not_downscaled_grc, default='inactive')

    this%forc_rain_not_downscaled_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='Rainf', units='mm/s',  &
         !#py avgflag='A', long_name='atmospheric rain', &
         !#py !#py ptr_gcell=this%forc_rain_not_downscaled_grc, default='inactive')

    this%forc_lwrad_not_downscaled_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='LWdown', units='W/m^2',  &
         !#py avgflag='A', long_name='atmospheric longwave radiation', &
         !#py !#py ptr_gcell=this%forc_lwrad_not_downscaled_grc, default='inactive')
...
!         ptr_lnd=this%forc_q_not_downscaled_grc)
    ...
    this%forc_q_not_downscaled_grc(begg:endg) = spval
    !#py call hist_addfld1d (fname='Qair', units='kg/kg',  &
         !#py avgflag='A', long_name='atmospheric specific humidity', &
         !#py !#py ptr_lnd=this%forc_q_not_downscaled_grc, default='inactive')
...
!         ptr_lnd=this%forc_pbot_not_downscaled_grc)
   ...
   !#py call hist_addfld1d (fname='HDM', units='counts/km^2',      &
         ...
         !#py !#py ptr_lnd=this%forc_hdm, default='inactive')

    !#py call hist_addfld1d (fname='LNFM', units='counts/km^2/hr',  &
         !#py avgflag='A', long_name='Lightning frequency',        &
         !#py !#py ptr_lnd=this%forc_lnfm, default='inactive')
#endif

    ! Time averaged quantities
    this%fsi24_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='FSI24', units='K',  &
         !#py avgflag='A', long_name='indirect radiation (last 24hrs)', &
         !#py !#py ptr_patch=this%fsi24_patch, default='inactive')

    this%fsi240_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='FSI240', units='K',  &
         !#py avgflag='A', long_name='indirect radiation (last 240hrs)', &
         !#py !#py ptr_patch=this%fsi240_patch, default='inactive')

    this%fsd24_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='FSD24', units='K',  &
         !#py avgflag='A', long_name='direct radiation (last 24hrs)', &
         !#py !#py ptr_patch=this%fsd24_patch, default='inactive')

    this%fsd240_patch(begp:endp) = spval
    !#py call hist_addfld1d (fname='FSD240', units='K',  &
         !#py avgflag='A', long_name='direct radiation (last 240hrs)', &
         !#py !#py ptr_patch=this%fsd240_patch, default='inactive')
  ...
  subroutine InitAccBuffer (this, bounds)
    ...
    !#py call init_accum_field (name='FSD24', units='W/m2',                                             &
    ...
    !#py call init_accum_field (name='FSD240', units='W/m2',                                            &
    ...
    !#py call init_accum_field (name='FSI24', units='W/m2',                                             &
    ...
    !#py call init_accum_field (name='FSI240', units='W/m2',                                            &
         !#py desc='240hr average of diffuse solar radiation',  accum_type='runmean', accum_period=-10, &
         !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)

    if (use_cn) then
       !#py call init_accum_field (name='PREC10', units='MM H2O/S', &
            !#py desc='10-day running mean of total precipitation', accum_type='runmean', accum_period=-10, &
            !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)

       !#py call init_accum_field (name='PREC60', units='MM H2O/S', &
            !#py desc='60-day running mean of total precipitation', accum_type='runmean', accum_period=-60, &
            !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)
    end if

    if ( use_fates ) then
       !#py call init_accum_field (name='PREC24', units='m', &
            !#py desc='24hr sum of precipitation', accum_type='runmean', accum_period=-1, &
            !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)

       ! Fudge - this neds to be initialized from the restat file eventually.
       !#py call init_accum_field (name='RH24', units='m', &
            !#py desc='24hr average of RH', accum_type='runmean', accum_period=-1, &
            !#py !#py subgrid_type='pft', numlev=1, init_value=100._r8)

       !#py call init_accum_field (name='WIND24', units='m', &
            !#py desc='24hr average of wind', accum_type='runmean', accum_period=-1, &
            !#py !#py subgrid_type='pft', numlev=1, init_value=0._r8)
    end if
  ...
  subroutine InitAccVars(this, bounds)
    ...
    !#py call extract_accum_field ('FSD24', rbufslp, nstep)
    this%fsd24_patch(begp:endp) = rbufslp(begp:endp)

    !#py call extract_accum_field ('FSD240', rbufslp, nstep)
    this%fsd240_patch(begp:endp) = rbufslp(begp:endp)

    !#py call extract_accum_field ('FSI24', rbufslp, nstep)
    this%fsi24_patch(begp:endp) = rbufslp(begp:endp)

    !#py call extract_accum_field ('FSI240', rbufslp, nstep)
    this%fsi240_patch(begp:endp) = rbufslp(begp:endp)

    if (use_cn) then
       !#py call extract_accum_field ('PREC10', rbufslp, nstep)
       this%prec10_patch(begp:endp) = rbufslp(begp:endp)

       !#py call extract_accum_field ('PREC60', rbufslp, nstep)
       this%prec60_patch(begp:endp) = rbufslp(begp:endp)
    end if

    if (use_fates) then
       !#py call extract_accum_field ('PREC24', rbufslp, nstep)
       this%prec24_patch(begp:endp) = rbufslp(begp:endp)

       !#py call extract_accum_field ('RH24', rbufslp, nstep)
       this%rh24_patch(begp:endp) = rbufslp(begp:endp)

       !#py call extract_accum_field ('WIND24', rbufslp, nstep)
...
!#py     !
!#py     ! !ARGUMENTS:
!#py     class(atm2lnd_type)                 :: this
!#py     type(bounds_type)      , intent(in) :: bounds
!#py     !
!#py     ! !LOCAL VARIABLES:
!#py     integer :: g,c,p                     ! indices
...
!#py        rbufslp(p) = this%forc_solad_grc(g,1)
!#py     end do
!#py     call update_accum_field  ('FSD240', rbufslp               , nstep)
!#py     call extract_accum_field ('FSD240', this%fsd240_patch     , nstep)
!#py     call update_accum_field  ('FSD24' , rbufslp               , nstep)
!#py     call extract_accum_field ('FSD24' , this%fsd24_patch      , nstep)
!#py
!#py     ! Accumulate and extract forc_solai24 & forc_solai240
!#py     do p = begp,endp
!#py        g = veg_pp%gridcell(p)
!#py        rbufslp(p) = this%forc_solai_grc(g,1)
!#py     end do
!#py     call update_accum_field  ('FSI24' , rbufslp               , nstep)
!#py     call extract_accum_field ('FSI24' , this%fsi24_patch      , nstep)
!#py     call update_accum_field  ('FSI240', rbufslp               , nstep)
!#py     call extract_accum_field ('FSI240', this%fsi240_patch     , nstep)
!#py
!#py     do p = begp,endp
!#py        c = veg_pp%column(p)
!#py        rbufslp(p) = this%forc_rain_downscaled_col(c) + this%forc_snow_downscaled_col(c)
!#py     end do
!#py
!#py     if (use_cn) then
!#py        ! Accumulate and extract PREC60 (accumulates total precipitation as 60-day running mean)
!#py        call update_accum_field  ('PREC60', rbufslp, nstep)
!#py        call extract_accum_field ('PREC60', this%prec60_patch, nstep)
!#py
!#py        ! Accumulate and extract PREC10 (accumulates total precipitation as 10-day running mean)
!#py        call update_accum_field  ('PREC10', rbufslp, nstep)
!#py        call extract_accum_field ('PREC10', this%prec10_patch, nstep)
!#py     end if
!#py
!#py     if (use_fates) then
!#py        call update_accum_field  ('PREC24', rbufslp, nstep)
!#py        call extract_accum_field ('PREC24', this%prec24_patch, nstep)
!#py
!#py        do p = bounds%begp,bounds%endp
!#py           c = veg_pp%column(p)
!#py           g = veg_pp%gridcell(p)
!#py           rbufslp(p) = this%forc_wind_grc(g)
!#py        end do
!#py        call update_accum_field  ('WIND24', rbufslp, nstep)
!#py        call extract_accum_field ('WIND24', this%wind24_patch, nstep)
!#py
!#py        do p = bounds%begp,bounds%endp
!#py           c = veg_pp%column(p)
!#py           g = veg_pp%gridcell(p)
!#py           rbufslp(p) = this%forc_rh_grc(g)
!#py        end do
!#py        call update_accum_field  ('RH24', rbufslp, nstep)
!#py        call extract_accum_field ('RH24', this%rh24_patch, nstep)
!#py     end if
!#py
...
!#py     !------------------------------------------------------------------------
!#py
!#py     call restartvar(ncid=ncid, flag=flag, varname='qflx_floodg', xtype=ncd_double, &
!#py          dim1name='gridcell', &
!#py          long_name='flood water flux', units='mm/s', &
!#py          interpinic_flag='skip', readvar=readvar, data=this%forc_flood_grc)
!#py     if (flag == 'read' .and. .not. readvar) then
!#py        ! initial run, readvar=readvar, not restart: initialize flood to zero
!#py        this%forc_flood_grc = 0._r8
!#py     endif
!#py
