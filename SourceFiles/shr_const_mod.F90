...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_100407/shr/shr_const_mod.F90 $
!===============================================================================
...
MODULE shr_const_mod
   ...
   !$acc declare copyin(SHR_CONST_PI    )
   !$acc declare copyin(SHR_CONST_CDAY  )
   !$acc declare copyin(SHR_CONST_SDAY  )
   !$acc declare copyin(SHR_CONST_OMEGA )
   !$acc declare copyin(SHR_CONST_REARTH)
   !$acc declare copyin(SHR_CONST_G     )

   !$acc declare copyin(SHR_CONST_STEBOL)
   !$acc declare copyin(SHR_CONST_BOLTZ )
   !$acc declare copyin(SHR_CONST_AVOGAD)
   !$acc declare copyin(SHR_CONST_RGAS  )
   !$acc declare copyin(SHR_CONST_MWDAIR)
   !$acc declare copyin(SHR_CONST_MWWV  )
   !$acc declare copyin(SHR_CONST_RDAIR )
   !$acc declare copyin(SHR_CONST_RWV   )
   !$acc declare copyin(SHR_CONST_ZVIR  )
   !$acc declare copyin(SHR_CONST_KARMAN)
   !$acc declare copyin(SHR_CONST_PSTD  )
   !$acc declare copyin(SHR_CONST_PDB   )

   !$acc declare copyin(SHR_CONST_TKTRIP )
   !$acc declare copyin(SHR_CONST_TKFRZ  )
   !$acc declare copyin(SHR_CONST_TKFRZSW)
   !$acc declare copyin(SHR_CONST_RHOFW )
   !$acc declare copyin(SHR_CONST_RHOSW )
   !$acc declare copyin(SHR_CONST_RHOICE)
   !$acc declare copyin(SHR_CONST_CPDAIR)
   !$acc declare copyin(SHR_CONST_CPWV  )
   !$acc declare copyin(SHR_CONST_CPVIR )
   !$acc declare copyin(SHR_CONST_CPFW  )
   !$acc declare copyin(SHR_CONST_CPSW  )
   !$acc declare copyin(SHR_CONST_CPICE )
   !$acc declare copyin(SHR_CONST_LATICE)
   !$acc declare copyin(SHR_CONST_LATVAP)
   !$acc declare copyin(SHR_CONST_LATSUB)
