...
contains
  ...
  subroutine LakeTemperature(bounds, num_lakec, filter_lakec, num_lakep, filter_lakep, &
    ...
    use TridiagonalMod     , only : Tridiagonal,Tridiagonal_SoilLittVertTransp
    ...
    print *, "Free after init:",free1/1.E+9
    #endif
    ...
    do fp = 1, num_lakep
       ...
       !beta(fc) = sabg_nir/max(1.e-5_r8,sabg(p))
       !beta(fc) = beta(fc) + (1._r8-beta(fc))*betavis
    ...
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after 1-5:",free1/1.E+9
   #endif
    ! For snow / soil
    call cpu_time(startt) 
    call SoilThermProp_Lake(bounds, num_lakec, filter_lakec, &
     ...
     call cpu_time(stopt) 
     print *, "TIMING LakeTemperature::SoilThermProp_Lake ",(stopt-startt)*1.E+3,"ms"
     
     ! call update_vars_LakeTemperature(gpuflag,"ThermProp")
     #ifdef _CUDA
     istat = cudaMemGetInfo(free1, total)
     print *, "Free after Thermprop:",free1/1.E+9
     #endif
   ...
   !  end do
    ...
    call cpu_time(stopt) 
    print *, "TIMING LakeTemperature::EnergyCheck ",(stopt-startt)*1.E+3,"ms"

    ! call update_vars_LakeTemperature(gpuflag,"EnergyCheck")
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
...
!   end do
    ...
    call cpu_time(stopt) 
    print *, "TIMING LakeTemperature::TridiagonalSolve ",(stopt-startt)*1.E+3,"ms"

    ! call update_vars_LakeTemperature(gpuflag,"TriDiag")

    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after TriDiag:",free1/1.E+9
    #endif
    !!!!!!!!!!!!!!!!!!!!!!!
    ...
    call cpu_time(stopt) 
    print *, "TIMING LakeTemperature::PhaseChange_Lake ",(stopt-startt)*1.E+3,"ms"
    !!!!!!!!!!!!!!!!!!!!!!!
    ! call update_vars_LakeTemperature(gpuflag,"Lake2")
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after Lake2:",free1/1.E+9
    #endif
...
!   ! call update_vars_LakeTemperature(gpuflag,"DensityCalc")
    ...
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after Mixing1stStage:",free1/1.E+9
    #endif

   !  ! call update_vars_LakeTemperature(gpuflag,"1stStage")
  ...
  ! call update_vars_LakeTemperature(gpuflag,"MixingFinal")
    ...
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after Lake3",free1/1.E+9
    #endif
   !  ! call update_vars_LakeTemperature(gpuflag,"Lake3")
    ...
    call cpu_time(stopt) 
    print *, "TIMING LakeTemperature::Diagnostics ",(stopt-startt)*1.E+3,"ms"
   !  ! call update_vars_LakeTemperature(gpuflag,"Conserv")
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after Conserv",free1/1.E+9
    #endif
    ...
    #ifdef _CUDA
    istat = cudaMemGetInfo(free1, total)
    print *, "Free after End:",free1/1.E+9
    #endif
    end associate
